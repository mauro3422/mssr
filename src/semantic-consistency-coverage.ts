...
export const MSSR_R4_GATE_A_COVERAGE = mssrSemanticCoverageCapabilityBatchSchema.parse([
  ...
  },
  {
    ...
    edges: [
      ...
      { id: "roadmap-producer", kind: "producer", status: "reserved", owner: "mssr", ref: "docs/decisions/0006-deterministic-semantic-consistency.md", note: "Must remain reserved until R4 evidence classification can prove a contradiction." },
      ...
      { id: "roadmap-host-adoption", kind: "host-adoption", status: "reserved", owner: "host", note: "No host producer should infer this message from prose similarity." },
    ],
  },
  {
    ...
    edges: [
      ...
      { id: "unresolved-producer", kind: "producer", status: "reserved", owner: "mssr", ref: "docs/decisions/0006-deterministic-semantic-consistency.md", note: "R4 must first define deterministic relation/claim resolution." },
      ...
      { id: "unresolved-host-adoption", kind: "host-adoption", status: "reserved", owner: "host" },
    ],
  },
]);
